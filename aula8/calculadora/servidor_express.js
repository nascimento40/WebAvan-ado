...
// http://localhost:3000/api/somar?num1=3&num2=6
...
// http://localhost:3000/api/subtrair?num1=3&num2=6
app.get('/api/subtrair', function (req, res) {
  var num1 = req.query.num1;
  var num2 = req.query.num2;
  res.send(`O resultado da substração é: ${calculadora.subtrair(num1, num2)}`);
});

// http://localhost:3000/api/dividir?num1=3&num2=6
app.get('/api/dividir', function (req, res) {
  var num1 = req.query.num1;
  var num2 = req.query.num2;
  res.send(`O resultado da divisão é: ${calculadora.multiplicar(num1, num2)}`);
});

// http://localhost:3000/api/multiplicar?num1=3&num2=6
app.get('/api/multiplicar', function (req, res) {
  var num1 = req.query.num1;
  var num2 = req.query.num2;
  res.send(`O resultado da multiplicação é: ${calculadora.dividir(num1, num2)}`);
});

// http://localhost:3000/api/calculadora?num1=3&num2=6
